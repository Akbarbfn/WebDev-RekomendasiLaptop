...
<div class="card card-primary card-outline">
    <div class="card-header">
        <h3 class="card-title">Rekomendasi 2023</h3>
    </div>
    <div class="card-body p-0 table-responsive">
        <table class="table table-bordered table-hover">
            ...
            <tr>
                ...
                <td>{{ $alternatifs[$key]->keterangan }}</td>
                <td>RP. {{ $alternatifs[$key]->harga }}</td>
                <td>
                  <img src="{{ asset('fotolaptop/'.$alternatifs[$key]->foto)}}" alt="" style="width: 70px;;">
                </td>
            </tr>
            @endforeach
        </table>
