...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="{{ url('/') }}">Kanglaptop.id</a></h1>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6" style="width: 19rem;">
                      <img src="{{ asset('fotolaptop/'.$barang->foto)}}" class="rounded mx-auto d-block" width="100%" alt="">
                    </div>
